...
namespace CAN_Software
{
	partial class dataStreamSaved
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Data stream has been saved";
			// 
			// label2
			// 
			...
			this.label2.Text = "to C:\\CarProfiles";
			// 
			// dataStreamSaved
			// 
			...
			this.Name = "dataStreamSaved";
			this.Text = "dataStreamSaved";
